...
/**
 * Custo para ativar Backend Functions num projeto.
 * Base44-style freemium: Free inclui o unlock (0 créditos). Soft limits futuros ok.
 */
...
export const PREMIUM_REQUIRED_MESSAGE =
  'Recurso Premium. GitHub e canais sociais (WhatsApp, Instagram, Facebook, YouTube, TikTok) estão nos planos pagos. Upload/leitura de mídia, publicar e Backend Functions (Auth + dados) estão no Free.';
