...
export const PLANS = [
  {
    ...
    features: [
      '50 créditos por dia',
      'Anexar imagens e vídeos (IA lê o conteúdo)',
      'Publicar em gocreate-app.web.app',
      'Badge “Feito com GoCreate”',
      'Backend Functions (Auth + base de dados) grátis',
      'Preview live (Sandpack)',
      'Painel do projeto (visão geral, usuários, dados)',
    ],
    cta: 'Plano atual',
  },
  {
    ...
    features: [
      ...
      'GitHub + WhatsApp, Instagram, Facebook, YouTube, TikTok',
      'Colaboradores e convites no projeto',
      'Análises, Marketing, Fluxos, MCP e Segredos',
      'API de dados do projeto',
  ...
  },
  {
    ...
    features: [
      ...
      'Soma aos créditos Free ou Pro',
      'Ideal para um boost rápido de gerações',
    ],
    cta: 'Comprar com Mercado Pago',
  },
];
