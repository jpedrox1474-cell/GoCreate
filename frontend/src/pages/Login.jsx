...
import { Mail, Lock, Loader2, ArrowLeft, Github } from 'lucide-react';
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-10">
        ...
        >
          ...
          <p className="text-center text-xs text-zinc-500 mt-5">
            ...
            <Link to="/register" state={{ from }} className="text-zinc-900 hover:underline font-semibold transition-all">
              Criar conta
            </Link>
          </p>
        </div>
