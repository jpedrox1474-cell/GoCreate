 ...
 * browser chrome + logo/custom image OR gradient + initials.
 */
    ...
    >
      ...
      {custom ? (
        <div className="absolute inset-0 pt-6">
          ...
          <div className="absolute inset-0 pt-6 bg-gradient-to-t from-zinc-950/70 via-transparent to-transparent" />
        </div>
      ) : (
        <div
      ...
      <div className="absolute bottom-3 left-3 flex items-center gap-2 z-[1]">
        <div className="w-8 h-8 rounded-lg bg-black/40 backdrop-blur-sm flex items-center justify-center border border-white/10 overflow-hidden">
          {custom ? (
            <img src={thumbnailUrl} alt="" className="w-full h-full object-cover" />
          ) : (
